...
import { Search, Plus, Edit3, UserCheck, UserX, Mail, Phone, Calendar, FileText, GraduationCap } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-gray-600">
              Créer et gérer les comptes des enseignants de l'école
            </p>
          </div>
          <button
