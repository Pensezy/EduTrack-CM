...
import { X, User as UserIcon, Mail, Phone, Key, Eye, EyeOff, Copy, CheckCircle, AlertCircle, Briefcase, RefreshCw, Lock } from 'lucide-react';
...
export default function SecretaryFormModal({ isOpen, onClose, user, onSuccess }) {
  ...
  /**
   * Met à jour le mot de passe de la secrétaire
   */
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          {newPassword && (
                            <button
                              type="button"
                              onClick={() => handleCopy(newPassword, 'newPassword')}
                              className="px-3 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors"
                              title="Copier"
                            >
                              {copied.newPassword ? <CheckCircle className="h-4 w-4 text-green-600" /> : <Copy className="h-4 w-4" />}
                            </button>
                          )}
                        </div>
                        <p className="mt-1 text-xs text-gray-500">
                          Minimum 8 caractères. Le mot de passe sera envoyé à la secrétaire.
                        </p>
                      </div>
